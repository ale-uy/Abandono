...
class Tools:
    ...
    @classmethod
    def importancia_variables(cls, df, target:str, n_estimators=100, save_model=False,
                              random_state=np.random.randint(1,1000), cv=5, model_filename="Random_Forest",
                              tipo_problema:str=None, eliminar=False, umbral=0.005)->tuple:
        """
        ...
        scoring = 'accuracy' if tipo_problema=='clasificacion' else 'squared_error'
        ...
        if eliminar:
            ...
            return print(f'\n {scoring.upper()}: {score}'), df_filtrado
        else:
            return print(f'\n {scoring.upper()}: {score}'), importancia_df
...
class ML:
    ...
    def modelo_catboost(cls, df, target:str, tipo_problema:str, test_size=0.2,
                        ...
                        save_model=False, model_filename='catboost', rejilla=False):
        """
    ...
    def modelo_adaboost(cls, df, target:str, tipo_problema:str,
                        ...
                        random_state=np.random.randint(1, 1000), graficar=False,
                        save_model=False, model_filename='adaboost', rejilla=False):
        """
